...
A <Link href="../ref-info/glossary-uid#gl-private-operator">Private Operator</Link> connects to the EUID <Link href="../ref-info/glossary-uid#gl-core-service">Core</Link> and <Link href="../ref-info/glossary-uid#gl-opt-out-service">Opt-Out</Link> services, and downloads data files directly from AWS S3 using URLs that the Core service provides. For details, see [Private Operator workflow](integration-options-private-operator.md#private-operator-workflow).
