...
### POST /identity/map v3 (Python SDK, Snowflake)

14 August, 2025

We've released updated versions of two additional docs to reflect adoption of the new version of the POST /identity/map API (v3), announced on 16 July, which provides significant improvements for advertisers and data providers.
