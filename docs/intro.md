...
EUID is a deterministic ID that is based on <Link href="ref-info/glossary-uid#gl-personal-data">personal data</Link>, such as email address. There are two types of EUIDs: raw EUIDs and EUID tokens (also known as advertising tokens). The following table explains each type.
