...
:::tip
To arrive at the hashed and Base64-encoded values of any email address or phone number value, use the [EUID Hashing Tool](gs-normalization-encoding.md#euid-hashing-tool).
:::
