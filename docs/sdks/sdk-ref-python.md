...
For the earlier version, see [Previous Version (Using POST /v2/identity/map)](#previous-version-using-post-v2identitymap). For migration steps to the latest version, see [Migration From Version Using POST /v2/identity/map](#migration-from-version-using-post-v2identitymap).
...
### Previous Version (Using POST /v2/identity/map)
