...
| `PREV_UID`     | TEXT      | The value is one of the following:<ul><li>Personal data was successfully mapped and a previous EUID exists: The previous EUID for this personal data. Previous EUIDs are available for 90 days after rotation.</li><li>No previous EUID exists or personal data was not successfully mapped: `NULL`.</li></ul>                                             |
| `REFRESH_FROM` | TIMESTAMP | The value is one of the following:<ul><li>Personal data was successfully mapped: The timestamp (in epoch seconds) indicating when this EUID should be refreshed.</li><li>Personal data was not successfully mapped: `NULL`.</li></ul>                                                                                                               |
