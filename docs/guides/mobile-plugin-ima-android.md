...
This documentation is for the EUID IMA Plugin for Android version 0.5.0 and later.
...
1. [EUID IMA Plugin for Android v0.5.0](https://central.sonatype.com/artifact/com.uid2/uid2-android-sdk-ima)
