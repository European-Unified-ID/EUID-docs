...
const componentData = {
  ...
  subheading: translate({
    ...
    message:
      "Easily integrate EUID into your existing workflows through a flexible framework of implementation types.",
  }),
};
...
function Partner({ partnerItem, playAnimation }: PartnerProps): JSX.Element {
  ...
  return (
    <div className={styles.card}>
      <Link
        className={clsx("text-light-black bg-dirty-socks", styles.cardLink)}
        to={url}
      >
