...
export default function HomepageConsumerBenefit(): JSX.Element {
  ...
  const componentData = {
    ...
    subheading: translate({
      ...
      message:
        "EUID was created to be conscious of consumer privacy and the regulatory requirements of the region as a top priority. Users can opt out of using their EUID universally by visiting the opt-out portal. Participants are required to honor user opt-out requests made through the portal.",
    }),
  };
