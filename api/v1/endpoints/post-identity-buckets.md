[EUID API Documentation](../../README.md) > [v1](../README.md) > [Endpoints](./README.md) > POST /identity/buckets
...
echo '[Unencrypted-JSON-Request-Body]' \
  ...
  | curl -X POST 'https://prod.uidapi.com/v2/identity/buckets' -H 'Authorization: Bearer [CLIENT_API_KEY]' \
