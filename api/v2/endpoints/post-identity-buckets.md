...
echo '[Unencrypted-JSON-Request-Body]' \
  ...
  | curl -X POST 'https://prod.euid.eu/v2/identity/buckets' -H 'Authorization: Bearer [CLIENT_API_KEY]' \
...
echo '{"since_timestamp": "2022-06-01T13:00:00"}' \
  ...
  | curl -X POST 'https://prod.euid.eu/v2/identity/buckets' -H 'Authorization: Bearer YourTokenBV3tua4BXNw+HVUFpxLlGy8nWN6mtgMlIk=' \
